      ...
      <aside className="relative flex h-full w-full max-w-2xl flex-col bg-white shadow-2xl">
        <header className="flex items-center justify-between border-b border-zinc-200 px-5 py-4">
          <div>
            ...
            <p className="text-xs text-zinc-500">Automatic snapshots, at most once per minute</p>
          </div>
        ...
        <div className="grid min-h-0 flex-1 grid-cols-[220px_1fr]">
          <div className="overflow-y-auto border-r border-zinc-200 bg-zinc-50 p-3">
            {loading ? (
              <p className="p-2 text-sm text-zinc-500">Loading history…</p>
            ) : versions.length === 0 ? (
          ...
          <div className="flex min-w-0 flex-col">
            {selected ? (
              <>
                ...
                <pre className="min-h-0 flex-1 overflow-auto whitespace-pre-wrap p-5 font-sans text-sm leading-7 text-zinc-800">
